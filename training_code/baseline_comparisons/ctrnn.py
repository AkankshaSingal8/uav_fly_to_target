...
with strategy.scope():
    ...
    mymodel.load_weights('./baseline_comparisons/model-ctrnn_ctrnn_seq-64_lr-0.000292_epoch-096_val-loss_0.0706_train-loss_0.0050_mse_0.0050_2022_04_18_23_58_35.hdf5')
...
epochs: int = 100
csv_logger = tf.keras.callbacks.CSVLogger(f'./baseline_comparisons/ctrnn_mix_goal_{decay_rate}_seed22222_lr{lr}_epoch{epochs}.csv', separator=',', append=False)
callbacks = None

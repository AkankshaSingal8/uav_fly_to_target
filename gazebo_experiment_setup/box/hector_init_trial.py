...
root = './retrain_diff_coreset_mix_heights_wscheduler0.85_seed22222_lr0.001_trainloss0.00014_epoch100.h5'
goal_image_file = './box_goal/goal_box_height3.png'
...
if __name__ == '__main__':
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if current_height < 5.9 and MODEL_MODE == False:  # If below the target height (account for some margin)

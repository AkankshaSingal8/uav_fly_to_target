...
goal_height = 3
CSV_FILE = f"./new_results_with_orientation/new_result_marker_x1_y1_z{goal_height + 3}_goal{goal_height}.csv"
# MSE_CSV_FILE = "MSE_marker_x0.4_y0_z8_goal6.csv"
...
GOAL_IMAGE_FILE = f"./marker_goal_images/goal_marker_height3_diffbackground.png"
...
csv_writer.writerow(["timestamp", "x", "y", "z", "quat_x", "quat_y", "quat_z", "quat_w", "vx", "vy", "vz", "wx", "wy", "wz"])
